        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order" >
                <fieldset>
                    ...
                    <textarea name="details" rows="10" placeholder="Intended pickup time and date" class="input-responsive" required></textarea>

                    <!-- get subtotal by taking price*quantity for each item in cart -->
                    <p class="order-label">Order Subtotal: <?php 
